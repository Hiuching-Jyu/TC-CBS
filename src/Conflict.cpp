...
std::ostream& operator<<(std::ostream& os, const Conflict& conflict)
{
	...
	{
    case conflict_priority::DUPLICATE_CONFIG:
        os << "duplicate-configuration ";
        break;
...
// conflict selection
// First select the duplicate conflict
// Second compare the cardinality: cardinal > semi-cardinal > non-cardinal (This step can be skipped by the user)
// Third compare the type:  mutex > target > corridor > rectangle > vertex/edge
// Fourth compare the user-specified tie-breaking rule: RANDOM, EARLIEST, CONFLICTS, MCONSTRAINTS, FCONSTRAINTS, WIDTH, SINGLETONS
